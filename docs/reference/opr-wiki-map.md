...
[John Paden's OPR wiki](https://gitlab.com/openpolarradar/opr/-/wikis/home) is the authoritative reference for the toolbox, but it assumes a lot of knowledge that some folks without an electrical engineering background might find hard to read.

This is an annotated index for the pages that are most important for our group's work.
...
| Page | Description |
|---|---|
| [Processing Steps](https://gitlab.com/openpolarradar/opr/-/wikis/Processing-Steps) | The step by step processing chain for along track synthetic aperture (SAR) processing  |
| [Parameter Spreadsheet Guide](https://gitlab.com/openpolarradar/opr/-/wikis/Parameter-Spreadsheet-Guide) | Guide to the parameter spreadsheets that define the Tx Rx pulses |
| [Cluster Guide](https://gitlab.com/openpolarradar/opr/-/wikis/Cluster-Guide) | Description of `cluster_*` functions, settings, Slurm and Torque |
| [Analysis](https://gitlab.com/openpolarradar/opr/-/wikis/Analysis) | Coherent noise, specular, deconvolution, equalization |
| [Deconvolution](https://gitlab.com/openpolarradar/opr/-/wikis/Deconvolution) |  More discussion of deconvolution alone |
...
Read these if you think there may be something missing from the data that have been processed.
